...
// caption SF 14.075/16 +0.25% (lead 590) at x 11.5, 12 under the media; meta 12.15 at x 12.5, 5 below; next card 23 below.
  card: { paddingBottom: 33 }, // Figma gap between posts 16 (was 14 in THIS.svg → 23 here)
  ...
  titleChip: {
    ...
    left: 5.25,
    bottom: 5.5,
    // Frame 292x52 at a 19.4 title, scaled with the title (20.15 / 19.4), then −2 wide and −1 tall by eye.
    width: 301.3,
    height: 53,
    paddingTop: 7.75, // 2px lower than the frame, by eye on the phone
    paddingHorizontal: 6,
    borderRadius: 13.5,
    overflow: 'hidden',
    borderWidth: 1,
  ...
  titleText: { width: 286.7, fontFamily: fonts.display, fontSize: 20.15, lineHeight: 20.77, letterSpacing: 20.15 * 0.01, color: colors.text },
