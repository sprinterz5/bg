...
// caption SF 14.075/16 +0.25% (lead 590) at x 11.5, 12 under the media; meta 12.15 at x 12.5, 5 below; next card 23 below.
  card: { paddingBottom: 35 }, // Figma gap between posts 16 (was 14 in THIS.svg → 23 here)
  ...
  captionBlock: { paddingLeft: 13, paddingRight: 19, marginTop: 14, gap: 5 }, // text box 358 wide (x 11.5..369.5)
