...
// caption SF 14.075/16 +0.25% (lead 590) at x 11.5, 12 under the media; meta 12 at x 12.5, 5 below; next card 23 below.
  ...
  lead: { fontWeight: '600' },
  time: { fontSize: 12, lineHeight: 16, marginLeft: 1, color: colors.textSubtle },
});
