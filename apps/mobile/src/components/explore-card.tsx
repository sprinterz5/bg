...
// caption SF 13.5/16 +0.25% (lead 590) at x 11.5, 12 under the media; meta 11.5 at x 12.5, 5 below; next card 23 below.
  ...
  caption: { fontSize: 13.5, lineHeight: 16, letterSpacing: 13.5 * 0.0025, color: colors.text },
  lead: { fontWeight: '600' },
