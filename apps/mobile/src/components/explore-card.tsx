...
// caption SF 14.15/16 +0.25% (lead 590) at x 11.5, 12 under the media; meta 11.5 at x 12.5, 5 below; next card 23 below.
  ...
  caption: { fontSize: 14.15, lineHeight: 16, letterSpacing: 14.15 * 0.0025, color: colors.text },
  lead: { fontWeight: '600' },
