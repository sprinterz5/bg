...
// caption SF 14.075/16 +0.25% (lead 590) at x 11.5, 12 under the media; meta 12.15 at x 12.5, 5 below; next card 23 below.
  card: { paddingBottom: 27 }, // Figma gap between posts 16 (was 14 in THIS.svg → 23 here)
  ...
  titleText: { width: 276, fontFamily: fonts.display, fontSize: 19.65, lineHeight: 20, letterSpacing: 18.4 * 0.01, color: colors.text },
